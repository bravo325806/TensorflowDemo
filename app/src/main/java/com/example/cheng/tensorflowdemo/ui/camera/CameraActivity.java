package com.example.cheng.tensorflowdemo.ui.camera;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFile = new File(getExternalFilesDir(null), "tf_" + time + ".jpg");
    }
...
//                    showToast("Saved: " + mFile);
    ...
    private void pictureFinish() {
        if (getIntent().getStringExtra("from").equals(MainActivity.class.getName())) {
            Intent intent = new Intent();
            intent.putExtra("image", mFile.getAbsolutePath());
            setResult(MainActivity.CAMERA_REQUEST, intent);
            finish();
        } else {
            Intent intent = new Intent();
            intent.putExtra("image", mFile.getAbsolutePath());
